...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1317972665, 2084524493, 0x1e0ffff0, 1,1000000 * COIN);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.hellcointools.com");
        vSeeds.emplace_back("seed-b.hellcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1296688602, 0, 0x207fffff, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
